...
| `0x04000800` reads `0D000020` on hardware; dingbat unimplemented (open bus) | IDENT | **closed 2026-09-04** — p45 MEMCTL: EWRAM wait field is live, `waits = 15 − WS`, 321/289/609 cycles at WS 13/14/4; apply it to the page-2 table |
...
| IntrWait/VBlankIntrWait return-path cost and the `0x03007FF8` flag protocol (HLE gaps; real-BIOS path proved exact) | SWITIME | **closed 2026-09-04** — p47 IWCYCLE: immediate return 192 = real BIOS, HLE 160 → add 32; protocol confirmed |
