...
- Flash, SRAM, EEPROM; RTC (host time unless the game sets it; the clock persists in the battery save
  as the FlashGBX/mGBA 16-byte trailer — [gba-rtc.md](gba-rtc.md)); GPIO rumble; tilt (Yoshi's Universal Gravitation, Koro Koro
